            ...
            <div className="mx-auto w-full px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 2xl:px-40 relative z-10">
                <div className="relative">
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-xs sm:text-xs font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80 mb-4">
                        ...
                        <motion.h1 
                            className="text-center text-2xl font-bold leading-tight tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl whitespace-normal px-4 sm:px-6 md:px-8 lg:px-10 max-w-full mx-auto text-white relative mb-4"
                            style={{
                        ...
                        <p className="text-xs lg:text-sm font-light leading-relaxed text-slate-300 max-w-3xl mx-auto">
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="mb-5 sm:mb-8">
                                    <Quote className="w-4 h-4 sm:w-6 sm:h-6 text-pink-500" strokeWidth={2} />
                                </div>
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Ahmad Rizki</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Fresh Graduate</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Sari Wulandari</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Ibu Rumah Tangga</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Budi Santoso</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Karyawan Bank</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Maya Indira</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Pekerja Pabrik</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Rian Pratama</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Introvert</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Putri Maharani</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Mahasiswa</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Dimas Prasetyo</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Driver Ojol</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Indah Sari</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Ex Karyawan Kontrak</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-1 overflow-hidden bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 transition-all duration-300 group hover:bg-black/50">
                            <CardContent className="relative z-10 p-5 sm:p-8 flex flex-col">
                                ...
                                <div className="flex items-center space-x-3 sm:space-x-5">
                                    ...
                                    <div>
                                        <h3 className="text-xs sm:text-base font-semibold text-white">Arif Rahman</h3>
                                        <p className="text-[10px] sm:text-sm text-white/70 font-light">Pemilik Warung</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
