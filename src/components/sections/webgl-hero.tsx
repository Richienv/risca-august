...
function HeroTitles() {
  return (
    <div className="text-left">
      ...
      >
        <div className="bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 text-gray-300 px-3 py-1.5 rounded-md text-[14px] font-medium">
      ...
      >
        <motion.h1
          className="text-left text-[48px] sm:text-[56px] lg:text-[64px] leading-tight tracking-tighter font-bold"
          style={{
      ...
      {/* Subtitle */}
      <motion.p
        className="text-[16px] leading-relaxed text-gray-300 text-left mb-8"
      ...
      <motion.div
        className="flex justify-start items-center gap-4 sm:gap-6"
        initial={{ opacity: 0, y: 15 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-1 sm:px-2 lg:px-4 py-8 sm:py-12 lg:py-16 max-w-7xl">
          <div className="relative flex w-full flex-col items-center justify-center">
            ...
            <div className="w-full flex flex-col items-center space-y-8">
              ...
              >
                <p className="text-white text-[22px] font-bold mb-1">
                  Limited Slots
                </p>
