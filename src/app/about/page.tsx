...
export default function AboutMeDetailsPage() {
          ...
          <div className="w-full">
            ...
            <div className="mt-12 lg:mt-16 text-center">
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link 
                  href="/testimonials"
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-400 to-amber-500 text-black px-8 py-4 rounded-xl font-semibold text-lg hover:from-yellow-300 hover:to-amber-400 transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-400/20 group"
                >
                  <span>Lihat Kisah Sukses Mereka</span>
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
                
                <Link 
                  href="/pricing"
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-green-400 hover:to-emerald-500 transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-xl hover:shadow-green-500/20 group"
                >
              ...
              <p className="text-xs sm:text-sm text-gray-400 mt-3">
                Baca testimoni nyata dari mereka yang sudah berhasil
              </p>
            </div>
          </div>
        </div>
