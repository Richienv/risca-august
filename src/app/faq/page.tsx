...
export default function FAQPage() {
  return (
    <>
      ...
      <div className="bg-black py-4 px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-7xl mx-auto">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 text-white hover:text-pink-400 transition-colors duration-200 group"
          >
